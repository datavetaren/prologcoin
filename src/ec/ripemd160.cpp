...
void ripemd160_process(ripemd160_state *self, const void *p0, unsigned long length)
{
...
void ripemd160_done(ripemd160_state *self, void *out0)
{
    unsigned char *out = (unsigned char *)out0;
